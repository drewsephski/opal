  ...
  return (
    <>
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup
                  ...
                  <Link
                    ...
                    <span className="text-foreground text-sm">Explore All Features</span>
                  ...
                  <h1
                    ...
                    Powerful Features for Modern AI Applications
                  </h1>
                  <p
                  ...
                  <div
                    ...
                    <Link href="/chat">
                      <RippleButton
                        ...
                        <span className="text-nowrap">Try Chat Demo</span>
                      </RippleButton>
                    </Link>
                  </div>
                  <Link href="/pricing">
      ...
      <CTASection
        ...
        description="Get started with our AI template in minutes and bring your ideas to life."
        primaryButtonText="Try Chat Demo"
