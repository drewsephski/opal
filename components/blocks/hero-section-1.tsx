                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup
                                    ...
                                    <a
                                        ...
                                        <span className="text-foreground text-sm">Deploy Your Autonomous Agent</span>
                                    ...
                                    <h1
                                        ...
                                        Your Vision, Our AI Agents.
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Transform your ideas into reality with cutting-edge AI agents designed for seamless integration and maximum impact.
                                    </p>
                                </AnimatedGroup>
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <a href="#features" onClick={(e) => handleSmoothScroll(e, '#features')}>
                                                <span className="text-nowrap">Discover Capabilities</span>
                                            </a>
                                        </Button>
                                    </div>
                                    <Button
                    ...
                    <div className="mx-auto max-w-7xl px-6">
                        <div className="text-center">
                            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
                                Powering Innovation with Leading Partners
                            </h2>
                            <p className="mt-4 text-lg leading-8 text-muted-foreground">
                                We collaborate with industry leaders to bring you the most robust and intelligent AI solutions.
                            </p>
                        </div>
                        <div id="customers" className="group relative m-auto max-w-5xl px-6">
...
const handleSmoothScroll = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>, targetId: string) => {
    ...
    if (targetElement) {
        window.scrollTo({
            top: targetElement.getBoundingClientRect().top + window.scrollY - 80, // Adjust 80px for fixed header
            behavior: 'smooth',
        })
    }
}
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-background/50 max-w-4xl rounded-2xl border backdrop-blur-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            <a
                                href="#hero" // Link to the hero section itself
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                ...
                                <Button
                                    ...
                                    <a href="#get-started" onClick={(e) => handleSmoothScroll(e, '#get-started')}>
                                        <span>Get Started</span>
                                    </a>
                                </Button>
                            </div>
                            <ThemeToggleButton theme={theme as "light" | "dark"} onClick={() => setTheme(theme === "dark" ? "light" : "dark")} />
                        </div>
                    </div>
                </div>
            </nav>
