  ...
  return (
    <header>
      <nav
        ...
        className={cn(
          "w-full px-2 group z-20",
          isChatPage ? "relative" : "fixed"
        )}>
        <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && !isChatPage && 'bg-background/50 max-w-4xl rounded-2xl border backdrop-blur-lg lg:px-5')}>
                  ...
                  <li key={index}>
                    <Link
                      ...
                      className={cn(
                        ...
                        activePage === item.href && "text-accent-foreground font-medium"
                      )}>
                      <span>{item.name}</span>
                    </Link>
                  </li>
